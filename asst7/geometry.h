...
typedef SimpleIndexedGeometry<VertexPN, unsigned int> SimpleIndexedGeometryPN;
typedef SimpleIndexedGeometry<VertexPNX, unsigned int> SimpleIndexedGeometryPNX;
typedef SimpleIndexedGeometry<VertexPNTBX, unsigned int> SimpleIndexedGeometryPNTBX;
